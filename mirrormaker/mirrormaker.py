...
def mirrormaker(github_token, github_user, github_org, gitlab_token, gitlab_api, gitlab_private, gitlab_archive, dry_run, delete_mirrors, delete_from_github, repo=None):
    ...
    actions = find_actions_to_perform(github_org, gitlab_repos, github_repos, delete_mirrors, delete_from_github)
...
def find_actions_to_perform(github_org, gitlab_repos, github_repos, delete_mirrors, delete_github):
    ...
    with click.progressbar(gitlab_repos, label='Checking mirrors status', show_eta=False) as bar:
        ...
        for gitlab_repo in bar:
            action = check_mirror_status(gitlab_repo, github_repos, delete_mirrors, delete_github)
            actions.append(action)

    return actions


def check_mirror_status(gitlab_repo, github_repos, delete_mirrors, delete_github):
    ...
    action = {
        ...
        'create_mirror': True, 'delete_mirrors': delete_mirrors
    }
